export const translations = {
    en: {
        ...
        about: {
            ...
            paragraph2: "Solving a problem, or an emerging need, in the face of current difficulties, makes Solves Problems required for the challenge.",
            paragraph3: "I started my career in programming, at the exact moment I saw the magic behind technological solutions, yeah..., I had no idea how all that was possible.",
            paragraph4: "However, even without knowing how it was done, I always wanted to be part of it, as a 13-year-old boy who didn't know how to turn on a computer, I wanted to be a programmer!",
    ...
    pt: {
        ...
        about: {
            ...
            paragraph2: "Resolver um problema ou uma necessidade emergente, diante das dificuldades atuais, torna-se o foco do desafio.",
            paragraph3: "Comecei minha carreira na programação, no momento exato em que vi a mágica por trás das soluções tecnológicas, sim..., eu não fazia ideia de como tudo aquilo era possível.",
            paragraph4: "No entanto, mesmo sem saber como era feito, eu sempre quis fazer parte disso, como um garoto de 13 anos que não sabia ligar um computador, queria ser programador!",
            paragraph5: "Hoje, dedico-me diariamente a transformar problemas em soluções, trazendo ideias ao mundo, apresentando-as, sem timidez, mas com um objetivo muito claro: ser útil para alguém.",
        },
        experience: {
